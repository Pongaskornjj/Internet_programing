  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      <View style={styles.searchWrapper}>
        ...
        <TextInput style={styles.searchInput} placeholder="ค้นหาสินค้าหรือแบรนด์..." placeholderTextColor="#999" value={search} onChangeText={setSearch} />
      </View>
...
const styles = StyleSheet.create({
  ...
  searchWrapper: { flexDirection: "row", alignItems: "center", backgroundColor: "#fff", marginHorizontal: 15, marginTop: 12, paddingHorizontal: 14, paddingVertical: 10, borderRadius: 12, gap: 8, shadowColor: "#000", shadowOpacity: 0.05, shadowRadius: 4, elevation: 1 },
